...
#define DEFAULT_FS_CONFIG                                        \
  (SWITCH_2POS << 6) + (SWITCH_2POS << 4) + (SWITCH_2POS << 2) + \
      (SWITCH_2POS << 0)
...
#define HALL_STICK_DEFAULT_DEADZONE 8
#define KNOB_DEFAULT_DEADZONE 30
...
#define IS_UCHARGER_CHARGE_END_ACTIVE() \
  gpio_read(UCHARGER_CHARGE_END_GPIO) ? 0 : 1
