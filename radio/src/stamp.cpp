...
#define DISPLAY_VERSION (VENDOR_VER VENDOR_STR)
#else
#define DISPLAY_VERSION VENDOR_VER VENDOR_STR
#endif
...
const char vers_stamp[] =
    "VERS" TAB ": " VERSION_TAG DISPLAY_VERSION "\"" CODENAME "\"";
#else
const char vers_stamp[] =
    "VERS" TAB ": " VERSION "-" VERSION_SUFFIX DISPLAY_VERSION " (" GIT_STR ")";
#endif
#endif
const char date_stamp[] = "DATE" TAB ": " DATE;
const char time_stamp[] = "TIME" TAB ": " TIME;
#elif defined(BOARD_NAME)
const char vers_stamp[] = "FW" TAB ": edgetx-" BOARD_NAME "\036VERS" TAB
                          ": " VERSION DISPLAY_VERSION " (" GIT_STR
                          ")"
                          "\036DATE" TAB ": " DATE " " TIME;
#elif defined(RADIOMASTER_RELEASE)
const char vers_stamp[] =
    "FW" TAB ": edgetx-" FLAVOUR "\036VERS" TAB ": RM Factory (" GIT_STR
    ")"
    "\036BUILT BY : EdgeTX"
    "\036DATE" TAB ": " DATE " " TIME;
#elif defined(JUMPER_RELEASE) || defined(IFLIGHT_RELEASE)
const char vers_stamp[] =
    "FW" TAB ": edgetx-" FLAVOUR "\036VERS" TAB ": Factory (" GIT_STR
    ")"
    "\036BUILT BY : EdgeTX"
    "\036DATE" TAB ": " DATE " " TIME;
#else
#if defined(VERSION_TAG)
const char vers_stamp[] =
    "FW" TAB ": edgetx-" FLAVOUR "\036VERS" TAB ": " VERSION_TAG DISPLAY_VERSION
    "\036NAME"
    ": " CODENAME "\036DATE" TAB ": " DATE " " TIME;
#else
const char vers_stamp[] =
    "FW" TAB ": edgetx-" FLAVOUR "\036VERS" TAB ": " VERSION
    "-" VERSION_SUFFIX DISPLAY_VERSION "\036GIT#" TAB ": " GIT_STR
    "\036DATE" TAB ": " DATE " " TIME;
#endif
#endif
...
#if defined(COLORLCD)
#if defined(VERSION_TAG)
__SECTION_USED(".fwversiondata")
const char firmware_version[] =
    "edgetx-" FLAVOUR "-" VERSION_TAG DISPLAY_VERSION " (" GIT_STR ")";
__SECTION_USED(".bootversiondata")
const char boot_version[] =
    "edgetx-" FLAVOUR "-" VERSION_TAG DISPLAY_VERSION " (" GIT_STR ")";
#else
__SECTION_USED(".fwversiondata")
const char firmware_version[] =
    "edgetx-" FLAVOUR "-" VERSION "-" VERSION_SUFFIX DISPLAY_VERSION
    " (" GIT_STR ")";
__SECTION_USED(".bootversiondata")
const char boot_version[] = "edgetx-" FLAVOUR "-" VERSION
                            "-" VERSION_SUFFIX DISPLAY_VERSION " (" GIT_STR ")";
#endif
#else
/* 128x64 does not have enough real estate to display more than basic VERSION */
__SECTION_USED(".fwversiondata")
const char firmware_version[] =
    "edgetx-" FLAVOUR "-" VERSION DISPLAY_VERSION " (" GIT_STR ")";
__SECTION_USED(".bootversiondata")
const char boot_version[] =
    "edgetx-" FLAVOUR "-" VERSION DISPLAY_VERSION " (" GIT_STR ")";
#endif
...
/**
 * Tries to find EdgeTX or OpenTX version in the first 1024 byte of either
 * firmware/bootloader (the one not running) or the buffer
