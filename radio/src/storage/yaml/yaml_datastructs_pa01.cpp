...
const struct YamlIdStr enum_ModuleType[] = {
    ...
    {0, NULL}};
const struct YamlIdStr enum_TrainerMultiplex[] = {{TRAINER_OFF, "OFF"},
                                                  {TRAINER_ADD, "ADD"},
                                                  {TRAINER_REPL, "REPL"},
                                                  {0, NULL}};
const struct YamlIdStr enum_BeeperMode[] = {{e_mode_quiet, "mode_quiet"},
...
const struct YamlIdStr enum_Functions[] = {
    ...
    {FUNC_TEST, "TEST"},
    {0, NULL}};
const struct YamlIdStr enum_TimerModes[] = {{TMRMODE_OFF, "OFF"},
                                            {TMRMODE_ON, "ON"},
                                            {TMRMODE_START, "START"},
                                            {TMRMODE_THR, "THR"},
...
const struct YamlIdStr enum_MixerMultiplex[] = {
    {MLTPX_ADD, "ADD"}, {MLTPX_MUL, "MUL"}, {MLTPX_REPL, "REPL"}, {0, NULL}};
...
const struct YamlIdStr enum_SwashType[] = {
    {SWASH_TYPE_NONE, "TYPE_NONE"}, {SWASH_TYPE_120, "TYPE_120"},
    {SWASH_TYPE_120X, "TYPE_120X"}, {SWASH_TYPE_140, "TYPE_140"},
    {SWASH_TYPE_90, "TYPE_90"},     {0, NULL}};
const struct YamlIdStr enum_SwitchSources[] = {
    ...
    {SWSRC_OFF, "OFF"},
    {0, NULL}};
const struct YamlIdStr enum_PotsWarnMode[] = {{POTS_WARN_OFF, "WARN_OFF"},
...
const struct YamlIdStr enum_FailsafeModes[] = {
    {FAILSAFE_NOT_SET, "NOT_SET"},   {FAILSAFE_HOLD, "HOLD"},
    {FAILSAFE_CUSTOM, "CUSTOM"},     {FAILSAFE_NOPULSES, "NOPULSES"},
    {FAILSAFE_RECEIVER, "RECEIVER"}, {0, NULL}};
...
const struct YamlIdStr enum_TelemetrySensorType[] = {
    ...
    {0, NULL}};
const struct YamlIdStr enum_ZoneOptionValueEnum[] = {{ZOV_Unsigned, "Unsigned"},
                                                     {ZOV_Signed, "Signed"},
                                                     {ZOV_Bool, "Bool"},
                                                     {ZOV_String, "String"},
                                                     {ZOV_Source, "Source"},
...
const struct YamlIdStr enum_USBJoystickIfMode[] = {
    ...
    {0, NULL}};
const struct YamlIdStr enum_USBJoystickCh[] = {{USBJOYS_CH_NONE, "CH_NONE"},
...
static const struct YamlNode struct_CalibData[] = {
    YAML_IDX_CUST("calib", r_calib, w_calib), YAML_SIGNED("mid", 16),
    YAML_SIGNED("spanNeg", 16), YAML_SIGNED("spanPos", 16), YAML_END};
static const struct YamlNode struct_signed_16[] = {
    YAML_IDX, YAML_SIGNED("val", 16), YAML_END};
static const struct YamlNode struct_TrainerMix[] = {
    YAML_IDX, YAML_UNSIGNED("srcChn", 6),
    YAML_ENUM("mode", 2, enum_TrainerMultiplex), YAML_SIGNED("studWeight", 8),
    YAML_END};
static const struct YamlNode struct_TrainerData[] = {
    YAML_ARRAY("calib", 16, 4, struct_signed_16, NULL),
    YAML_ARRAY("mix", 16, 4, struct_TrainerMix, NULL), YAML_END};
static const struct YamlNode struct_anonymous_1[] = {YAML_STRING("name", 8),
                                                     YAML_END};
static const struct YamlNode struct_anonymous_2[] = {
    YAML_SIGNED("val", 16), YAML_UNSIGNED("mode", 8), YAML_UNSIGNED("param", 8),
    YAML_SIGNED("val2", 32), YAML_END};
static const struct YamlNode struct_anonymous_3[] = {
    YAML_SIGNED("val1", 32), YAML_SIGNED("val2", 32), YAML_END};
static const struct YamlNode union_anonymous_0_elmts[] = {
    ...
    YAML_STRUCT("clear", 64, struct_anonymous_3, NULL), YAML_END};
...
static const struct YamlNode struct_RadioData[] = {
    ...
    YAML_ARRAY("sticksConfig", 0, MAX_STICKS, struct_stickConfig,
               stick_name_valid),
    ...
    YAML_ARRAY("flexSwitches", 0, MAX_FLEX_SWITCHES, struct_flexSwitch,
               flex_sw_valid),
...
static const struct YamlNode struct_CurveRef[] = {
    ...
    YAML_UNSIGNED_CUST("value", 11, r_sourceNumVal, w_sourceNumVal), YAML_END};
...
static const struct YamlNode struct_ExpoData[] = {
    ...
    YAML_STRING("name", 6),
    YAML_END};
static const struct YamlNode struct_CurveHeader[] = {YAML_IDX,
...
static const struct YamlNode struct_signed_8[] = {
    YAML_IDX, YAML_SIGNED("val", 8), YAML_END};
...
static const struct YamlNode struct_trim_t[] = {
    YAML_IDX, YAML_SIGNED("value", 11), YAML_UNSIGNED("mode", 5), YAML_END};
static const struct YamlNode struct_FlightModeData[] = {
    ...
    YAML_END};
static const struct YamlNode struct_GVarData[] = {YAML_IDX,
                                                  YAML_STRING("name", 3),
...
static const struct YamlNode struct_RssiAlarmData[] = {
    ...
    YAML_CUSTOM("critical", r_rssiCritical, nullptr), YAML_END};
static const struct YamlNode struct_RFAlarmData[] = {
    YAML_SIGNED("warning", 8), YAML_SIGNED("critical", 8), YAML_END};
static const struct YamlNode struct_PpmModule[] = {
    YAML_SIGNED("delay", 6), YAML_UNSIGNED("pulsePol", 1),
    YAML_UNSIGNED("outputType", 1), YAML_SIGNED("frameLength", 8), YAML_END};
...
static const struct YamlNode struct_anonymous_7[] = {
    YAML_PADDING(6), YAML_UNSIGNED("noninverted", 1), YAML_PADDING(1),
    YAML_SIGNED("refreshRate", 8), YAML_END};
static const struct YamlNode struct_string_64[] = {
    YAML_IDX, YAML_STRING("val", 8), YAML_END};
static const struct YamlNode struct_anonymous_8[] = {
    YAML_UNSIGNED("receivers", 7), YAML_UNSIGNED("racingMode", 1),
    YAML_ARRAY("receiverName", 64, 3, struct_string_64, NULL), YAML_END};
...
static const struct YamlNode struct_anonymous_10[] = {
    YAML_UNSIGNED("emi", 2),     YAML_UNSIGNED("telemetry", 1),
    YAML_UNSIGNED("phyMode", 3), YAML_UNSIGNED("reserved", 2),
    YAML_UNSIGNED("rfPower", 8), YAML_END};
static const struct YamlNode struct_anonymous_11[] = {
    YAML_UNSIGNED("raw12bits", 1), YAML_UNSIGNED("telemetryBaudrate", 3),
    YAML_PADDING(4), YAML_END};
...
static const struct YamlNode struct_anonymous_13[] = {
    YAML_UNSIGNED("flags", 8), YAML_UNSIGNED("enableAETR", 1), YAML_END};
...
static const struct YamlNode union_ScriptDataInput_elmts[] = {
    ...
    YAML_UNSIGNED_CUST("source", 16, r_mixSrcRaw, w_mixSrcRaw), YAML_END};
...
static const struct YamlNode struct_ScriptData[] = {
    YAML_IDX, YAML_STRING("file", 6), YAML_STRING("name", 6),
    YAML_ARRAY("inputs", 16, 6, union_ScriptDataInput, NULL), YAML_END};
static const struct YamlNode struct_string_32[] = {
    YAML_IDX, YAML_STRING("val", 4), YAML_END};
static const struct YamlNode union_anonymous_14_elmts[] = {
    YAML_UNSIGNED("id", 16), YAML_UNSIGNED("persistentValue", 16), YAML_END};
static const struct YamlNode struct_anonymous_16[] = {
    YAML_UNSIGNED("physID", 5), YAML_UNSIGNED("rxIndex", 3), YAML_END};
static const struct YamlNode union_anonymous_15_elmts[] = {
    ...
    YAML_ENUM("formula", 8, enum_TelemetrySensorFormula), YAML_END};
static const struct YamlNode struct_anonymous_18[] = {
    YAML_UNSIGNED("ratio", 16), YAML_SIGNED("offset", 16), YAML_END};
static const struct YamlNode struct_anonymous_19[] = {
    YAML_UNSIGNED("source", 8), YAML_UNSIGNED("index", 8), YAML_PADDING(16),
    YAML_END};
static const struct YamlNode struct_anonymous_20[] = {
    YAML_ARRAY("sources", 8, 4, struct_signed_8, NULL), YAML_END};
static const struct YamlNode struct_anonymous_21[] = {
    YAML_UNSIGNED("source", 8), YAML_PADDING(24), YAML_END};
static const struct YamlNode struct_anonymous_22[] = {
    YAML_UNSIGNED("gps", 8), YAML_UNSIGNED("alt", 8), YAML_PADDING(16),
    YAML_END};
...
static const struct YamlNode struct_ZoneOptionValueTyped[] = {
    YAML_IDX, YAML_ENUM("type", 32, enum_ZoneOptionValueEnum),
    YAML_UNION("value", 96, union_ZoneOptionValue_elmts, select_zov), YAML_END};
...
static const struct YamlNode struct_ZonePersistentData[] = {
    YAML_IDX, YAML_STRING("widgetName", 20),
...
static const struct YamlNode struct_CustomScreenData[] = {
    YAML_IDX, YAML_STRING("LayoutId", 12),
...
static const struct YamlNode struct_TopBarPersistentData[] = {
    ...
    YAML_ARRAY("options", 128, 1, struct_ZoneOptionValueTyped, NULL), YAML_END};
static const struct YamlNode struct_string_24[] = {
    YAML_IDX, YAML_STRING("val", 3), YAML_END};
static const struct YamlNode struct_RGBLedColor[] = {
    YAML_IDX, YAML_UNSIGNED("r", 8), YAML_UNSIGNED("g", 8),
    YAML_UNSIGNED("b", 8), YAML_END};
...
static const struct YamlNode struct_ModelData[] = {
    ...
    YAML_ARRAY("switchNames", 24, 4, struct_string_24, NULL),
    YAML_ARRAY("functionSwitchLedONColor", 24, 4, struct_RGBLedColor, NULL),
    YAML_ARRAY("functionSwitchLedOFFColor", 24, 4, struct_RGBLedColor, NULL),
...
static const struct YamlNode struct_PartialModel[] = {
    YAML_STRUCT("header", 1048, struct_ModelHeader, NULL),
    YAML_ARRAY("timers", 136, 3, struct_TimerData, NULL), YAML_END};

#define MAX_RADIODATA_MODELDATA_PARTIALMODEL_STR_LEN 29

static const struct YamlNode __RadioData_root_node =
    YAML_ROOT(struct_RadioData);

const YamlNode* get_radiodata_nodes() { return &__RadioData_root_node; }
static const struct YamlNode __ModelData_root_node =
    YAML_ROOT(struct_ModelData);

const YamlNode* get_modeldata_nodes() { return &__ModelData_root_node; }
static const struct YamlNode __PartialModel_root_node =
    YAML_ROOT(struct_PartialModel);

const YamlNode* get_partialmodel_nodes() { return &__PartialModel_root_node; }
